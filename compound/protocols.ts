...
import { Compound, Powerpool, Uniswap, Yearn } from "@boardroom/sdk";

const providerUrl = process.env.REACT_APP_RPC_URL_1;

// supported protocols
export const protocols: Record<string, ProtocolDescription> = {
  compound: {
    name: "Compound",
    isEnabled: true,
    isCompoundish: true,
    ...
    hasOnchain: true,
    hasSnapshot: false,
    fetcher: new Compound(providerUrl),
  },
  uniswap: {
    name: "Uniswap",
    isEnabled: true,
    ...
    hasOnchain: true,
    hasSnapshot: true,
    fetcher: new Uniswap(providerUrl),
  },
  synthetix: {
    name: "Synthetix",
    isEnabled: true,
  ...
  powerpool: {
    ...
    canPropose: false,
    hasSnapshot: false,
    fetcher: new Powerpool(providerUrl)
  },
  rarible: {
    name: "Rarible",
    isEnabled: true,
...
export const AddressContractNameMap: Record<string, string> = {
  ...
  "0xefe147ffc12b847c0f2b6f19c11fa8266a8e3ddf": "powerpool",
  "0x38e4adb44ef08f22f5b5b76a8f0c2d0dcbe7dca1": "powerpool",
  ...
  "0xaba8cac6866b83ae4eec97dd07ed254282f6ad8a": "yam",
  "0x80fb784b7ed66730e8b1dbd9820afd29931aab03": "aave",
...
const alternateProtocolNames: Record<string, string> = {
  compound: "compound", 
  uniswap: "uniswap",
  synthetix: "synthetix",
  synthetixcouncil: "synthetix",
  synthetixproposal: "synthetix",
  yearn: "yearn",
  powerpool: "powerpool",
  rarible: "rarible",
  pooltogether: "pooltogether", 
  gnosis: "gnosis",
  defidollar: "defidolla.eth",
  defidolla: "defidolla.eth",
  "defidolla.eth": "defidolla.eth",
  siren: "siren",
  aave: "aave",
  yam: "yamv2",
  yamv2: "yamv2",
...
export const getProtocolName = (alias: string) => {
  if (alternateProtocolNames[alias]) {
    return alternateProtocolNames[alias];
  }
  return "";
};

export const protocolBranding: Record<string, Record<string, string>> = {
  default: {
...
export const fullProtocolLogos: Record<string, string> = {
};

export function fetchProtocolDescription(protocol: string) {
  if (["defidolla.eth", "defidollar", "defidolla"].includes(protocol)) {
    return protocols["defidollar"];
  } else if (["indexCoop", "index"].includes(protocol)) {
    return protocols["index"];
  } else {
    return protocols[getProtocolName(protocol)];
  }
}

export const forumProtocolUrls: Record<string, Record<string, string>> = {
  indexCoop: {
    discourse_url: "https://gov.indexcoop.com",
    category_id: "5",
  },
  gnosis: {
    discourse_url: "https://forum.gnosis.io",
    category_id: "20",
  },
  rarible: {
    discourse_url: "https://gov.rarible.com",
    category_id: "7",
  },
  pooltogether: {
    discourse_url: "https://gov.pooltogether.com",
    category_id: "1",
  },
    yamv2: {
    discourse_url: "https://forum.yam.finance",
    category_id: "9",
  },
  "defidolla.eth": {
   discourse_url: "https://forum.dusd.finance",
   category_id: "7",    
  },  
};
